...
const defaultAnnouncements: Announcement[] = [
  ...
  },
  {
    ...
    tagVariant: "blue",
    icon: BookOpen,
    title: "CNTS Learning Academy Now Live — Interactive Preparation Starts Here",
    date: "20 July 2026",
    content:
      "The CNTS Learning Academy is fully operational with bilingual interactive lessons across Reasoning, Mathematics, Language, and Critical Thinking. Candidates are advised to complete all topic modules, attempt the practice flashcards, and review their solved examples before test week.",
