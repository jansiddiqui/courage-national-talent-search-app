                    ...
                    <div className="grid grid-cols-3 gap-4 items-center">
                      ...
                      <div className="col-span-2 space-y-3 pl-2">
                        <div>
                          ...
                          <strong className="text-white text-xs md:text-sm font-semibold truncate block">{candidateResult.candidate.student_name}</strong>
                        </div>
                        <div className="grid grid-cols-2 gap-2">
                          <div>
                            <span className="text-[7px] text-white/40 uppercase font-black tracking-wider block">Class</span>
                            <strong className="text-white text-xs font-semibold">Class {candidateResult.candidate.student_class}</strong>
                          </div>
                          <div>
                            <span className="text-[7px] text-white/40 uppercase font-black tracking-wider block">State</span>
                            <strong className="text-white text-xs font-semibold">{candidateResult.candidate.state}</strong>
                          </div>
                        </div>
                        <div className="grid grid-cols-2 gap-2">
                          <div>
                            <span className="text-[7px] text-white/40 uppercase font-black tracking-wider block">Candidate ID</span>
                            <strong className="text-amber-400 font-mono text-xs font-bold uppercase tracking-wider block truncate">{candidateResult.candidate.cnts_id || candidateResult.candidate.registration_id}</strong>
                          </div>
                          <div>
                            <span className="text-[7px] text-white/40 uppercase font-black tracking-wider block">Enrollment Status</span>
                            <strong className="text-white text-[10px] font-semibold block">{candidateResult.candidate.payment_status === "PAID" ? "Enrolled / Active" : "Pending Payment"}</strong>
                          </div>
                        </div>
                      </div>
                    </div>
