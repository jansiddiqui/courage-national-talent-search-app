              ...
              <div className="bg-white rounded-3xl border border-slate-100 p-6 md:p-8 shadow-sm space-y-6">
                ...
                <div className="grid sm:grid-cols-2 gap-6">
                  ...
                  <div className="bg-slate-50 border border-slate-100 rounded-2xl p-5 space-y-4">
                    <span className="text-[10px] text-blue-750 font-bold uppercase tracking-wider bg-blue-50 px-2.5 py-1 rounded-md border border-blue-100">
                      Class 5 & 6 (Sub-Junior)
                    </span>
                    <div className="grid grid-cols-2 gap-2.5 pt-2">
                      <div>
                        <span className="text-[9px] text-slate-400 font-bold uppercase tracking-wider block">Questions</span>
                        <strong className="text-slate-800 font-display font-bold text-sm block mt-0.5">{SUB_JUNIOR_QUESTIONS} MCQs</strong>
                      </div>
                      <div>
                        <span className="text-[9px] text-slate-400 font-bold uppercase tracking-wider block">Duration</span>
                        <strong className="text-slate-800 font-display font-bold text-sm block mt-0.5">{SUB_JUNIOR_DURATION}</strong>
                      </div>
                      <div>
                        <span className="text-[9px] text-slate-400 font-bold uppercase tracking-wider block">Per Domain</span>
                        <strong className="text-slate-800 font-display font-bold text-sm block mt-0.5">{SUB_JUNIOR_PER_DOMAIN} Qs</strong>
                      </div>
                      <div>
                        <span className="text-[9px] text-slate-400 font-bold uppercase tracking-wider block">Mode</span>
                        <strong className="text-slate-800 font-display font-bold text-sm block mt-0.5">{EXAM_MODE}</strong>
                      </div>
                    </div>
                  </div>

                  {/* Junior Category */}
                  <div className="bg-slate-900 border border-slate-850 rounded-2xl p-5 space-y-4 text-white">
                    <span className="text-[10px] text-blue-300 font-bold uppercase tracking-wider bg-white/5 px-2.5 py-1 rounded-md border border-white/10">
                      Class 7 & 8 (Junior)
                    </span>
                    <div className="grid grid-cols-2 gap-2.5 pt-2">
                      <div>
                        <span className="text-[9px] text-slate-400 font-bold uppercase tracking-wider block">Questions</span>
                        <strong className="text-white font-display font-bold text-sm block mt-0.5">{JUNIOR_QUESTIONS} MCQs</strong>
                      </div>
                      <div>
                        <span className="text-[9px] text-slate-400 font-bold uppercase tracking-wider block">Duration</span>
                        <strong className="text-white font-display font-bold text-sm block mt-0.5">{JUNIOR_DURATION}</strong>
                      </div>
                      <div>
                        <span className="text-[9px] text-slate-400 font-bold uppercase tracking-wider block">Per Domain</span>
                        <strong className="text-white font-display font-bold text-sm block mt-0.5">{JUNIOR_PER_DOMAIN} Qs</strong>
                      </div>
                      <div>
                        <span className="text-[9px] text-slate-400 font-bold uppercase tracking-wider block">Mode</span>
                        <strong className="text-white font-display font-bold text-sm block mt-0.5">{EXAM_MODE}</strong>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-3 pt-2">
                  <h4 className="font-display font-bold text-slate-800 text-sm">Subject Weightage (Equal 25% each):</h4>
                  <div className="space-y-2">
                    {[
                      { subject: "Verbal Ability & Language Context", percentClass56: `${SUB_JUNIOR_PER_DOMAIN} Qs`, percentClass78: `${JUNIOR_PER_DOMAIN} Qs` },
                      { subject: "Mathematical & Quant Analysis", percentClass56: `${SUB_JUNIOR_PER_DOMAIN} Qs`, percentClass78: `${JUNIOR_PER_DOMAIN} Qs` },
                      { subject: "Logical & Inductive Reasoning", percentClass56: `${SUB_JUNIOR_PER_DOMAIN} Qs`, percentClass78: `${JUNIOR_PER_DOMAIN} Qs` },
                      { subject: "Critical Thinking & Cognitive Aptitude", percentClass56: `${SUB_JUNIOR_PER_DOMAIN} Qs`, percentClass78: `${JUNIOR_PER_DOMAIN} Qs` }
                    ].map((w, idx) => (
                      <div key={idx} className="flex justify-between items-center p-3 bg-slate-50 border border-slate-100 rounded-xl text-xs font-semibold">
                        ...
                        <div className="flex gap-4">
                          <span className="text-blue-800 font-bold text-[10px]">C5-6: {w.percentClass56}</span>
                          <span className="text-indigo-800 font-bold text-[10px]">C7-8: {w.percentClass78}</span>
                        </div>
                      </div>
                    ))}
                  </div>
