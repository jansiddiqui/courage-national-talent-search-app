...
export default function ReasoningHub() {
  ...
  const topics = ContentCMS.getAllTopics().filter(t => t.slug === "analogy" || t.slug === "classification" || t.slug === "coding-decoding" || t.slug === "number-series" || t.slug === "alphabet-series");
  const paths = ContentCMS.getLearningPaths();
    ...
    return (
      <div className="bg-white rounded-3xl border border-slate-100 p-6 sm:p-8 shadow-sm">
        ...
        <div className="space-y-4">
          {[
            { title: "Verbal Logic", desc: "Analogies, classification, coding patterns", key: "Verbal" },
            { title: "Numerical Logic", desc: "Sequences, progression intervals", key: "Numerical" },
            { title: "Spatial Thinking", desc: "Grid shapes, mirrors, paper folds", key: "Spatial" },
            { title: "Analytical Reasoning", desc: "Blood mapping, seating layout matrix", key: "Analytical" }
          ].map(skill => {
          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-blue-55 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-100 rounded-3xl p-6 sm:p-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 animate-fade-in shadow-xs">
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-1.5 leading-relaxed">
                    {selectedLanguage === "en" 
                      ? "Continue your cognitive journey. Unlocks the next reasoning milestones." 
                      : "अपनी संज्ञानात्मक यात्रा जारी रखें। अगले तार्किक मील के पत्थर को अनलॉक करें।"}
                  </p>
                </div>
                <Link
                  href={`/academy/reasoning/${recommendedTopic.slug}/learn`}
            ...
            {learningMode === "revision" && (
              <div className="bg-violet-50/50 border border-violet-100 rounded-3xl p-6 sm:p-8 space-y-4 animate-fade-in shadow-xs">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <Link 
                    href="/academy/reasoning/alphabet-series/tricks"
                  ...
                  <Link 
                    href="/academy/reasoning/number-series/tricks"
                    className="p-3 bg-white hover:bg-slate-50 rounded-xl border border-slate-100 text-xs font-bold text-slate-700 flex justify-between items-center transition-colors"
                  >
            ...
            <div className="bg-white rounded-3xl border border-slate-100 p-6 sm:p-8 shadow-sm">
              <h3 className="text-xl sm:text-2xl font-black font-display text-slate-800 mb-6 flex items-center gap-2">
                <Brain className="text-blue-800" size={22} />
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {path.topics.map(slug => {
                      ...
                      const linkHref = learningMode === "revision" 
                        ? `/academy/reasoning/${slug}/worksheet` 
                        : learningMode === "challenge" 
                        ? `/academy/reasoning/${slug}/practice` 
                        : `/academy/reasoning/${slug}/learn`;
          ...
          <div className="space-y-6">
                ...
                <div className="space-y-2.5">
                  {progress.bookmarks.map(slug => {
                    ...
                    return (
                      <Link 
                        key={slug} 
                        href={`/academy/reasoning/${slug}/learn`}
            ...
            <div className="bg-gradient-to-br from-indigo-900 to-slate-950 text-white rounded-3xl p-6 sm:p-8 shadow-md relative overflow-hidden">
              ...
              <p className="text-indigo-200/80 text-xs sm:text-sm mt-2.5 leading-relaxed">
                Test your logic with a daily-changing reasoning puzzle. No login required.
              </p>
              
              <Link 
                href="/academy/reasoning/analogy/practice" 
